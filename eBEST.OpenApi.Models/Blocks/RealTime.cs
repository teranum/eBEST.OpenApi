...
/// <summary>
/// 시간외단일가VI발동해제(DVI): DVI
/// </summary>
/// <param name="vi_gubun">구분(0:해제 1:정적발동 2:동적발동 3:정적&동적)	string	1</param>
